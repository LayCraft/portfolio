...
export const JOBS: iJob[] = [
  ...
  },
  {
    ...
    bonus: [
      ...
      "Built and deployed an application for Community Prevention Unit front-end portal for Microsoft Dynamics Attourney General. using ASP.Net Core",
      ...
      "Triggered devops piplines in OpenShift manually to deploy production applications.",
      ...
      "Angular authentication guarding, routing, and http interceptors.",
      "Application integration with with BCGov's SiteMinder authentication system.",
      ...
      "Work with Github flow and code migration strategy on repos linked to Openshift using webhooks.",
