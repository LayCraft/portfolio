...
export const JOBS: Job[] = [
	{
		...
		endDate: 'present',
		shortDescription: 'Build and maintain web applications hosted in OpenShift. From DevOps to UI.',
		longDescription: 'Build and maintain web applications written with Angular, Bootstrap, and .NET Core for use on OpenShift. From DevOps to UI interactions.',
		bonus: [
			'MS SQL database management in OpenShift using port-forwarding and Azure Data Studio.',
			'Build Angular reactive forms and validation using Bootstrap.',
			...
			'DevOps experience and training with OpenShift. Knowledge of ',
			'User stories, comments, bugs, and task tracking in Jira.',
			'As a developer I write user stories so that I can accomplish a programming task to meet set acceptance criteria.',
